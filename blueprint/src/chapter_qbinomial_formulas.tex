...
\lean{AlgebraicCombinatorics.QBinomialRec.prod_add_eq_sum_over_subsets}
\leantarget
\leanok
...
\lean{AlgebraicCombinatorics.QBinomialRec.qBinomial_first_theorem}
\leantarget
\leanok
Let $K$ be a
...
\lean{AlgebraicCombinatorics.QBinomialRec.qBinomial_second_theorem}
\leantarget
\leanok
...
\lean{AlgebraicCombinatorics.QBinomialRec.linearIndependent_iff_not_mem_span_of_lt}
\leantarget
\leanok
...
\lean{AlgebraicCombinatorics.QBinomialRec.card_linearIndependent_tuples}
\leantarget
\leanok
...
\lean{AlgebraicCombinatorics.QBinomialRec.card_eq_mul_of_fibers}
\leantarget
\leanok
Let $A$ and $B$ be two
...
\lean{AlgebraicCombinatorics.QBinomialRec.qBinomial_subspace_count}
\leantarget
\leanok
Let $F$ be a finite field. Let
$n,k\in\mathbb{N}$. Let $V$ be an $n$-dimensional $F$-vector space. Then,
...
\lean{AlgebraicCombinatorics.QBinomialRec.qBinomial_limit}
\leantarget
\leanok
