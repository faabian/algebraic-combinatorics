...
\lean{AlgebraicCombinatorics.qBinomial_eq_sum_increasing_tuples, AlgebraicCombinatorics.QBinomialRec.qBinomial_eq_sum_subsets, AlgebraicCombinatorics.qBinomial_one_eq_binomial}
\leantarget
\leanok
Let $n\in\mathbb{N}$ and $k\in\mathbb{Z}$.
