...
\lean{WeightedSet, WeightedSet.IsFiniteType, WeightedSet.weightGenFun, WeightedSet.Isomorphism, WeightedSet.AreIsomorphic}
\leantarget
\leanok
...
\lean{WeightedSet.weightGenFun_eq_of_isomorphic}
\leantarget
\leanok
...
\lean{WeightedSet.disjointUnion}
\leantarget
\leanok
...
\lean{WeightedSet.disjointUnion_isFiniteType, WeightedSet.weightGenFun_disjointUnion}
\leantarget
\leanok
...
\lean{WeightedSet.prod_isFiniteType, WeightedSet.weightGenFun_prod}
\leantarget
\leanok
Let $A$ and $B$ be two finite-type weighted sets. Then,
...
\lean{WeightedSet.pow_isFiniteType, WeightedSet.weightGenFun_pow}
\leantarget
\leanok
...
\lean{WeightedSet.pow_succ_equiv}
\leanhelper
\leanok
...
\lean{WeightedSet.tuples_isFiniteType}
\leanhelper
\leanok
...
\lean{DominoTilingsZ.Shape, DominoTilingsZ.Rectangle, DominoTilingsZ.Domino, DominoTilingsZ.Tiling, DominoTilingsZ.numTilings}
\leantarget
\leanok
...
\lean{DominoTilingsZ.tiling_decomposition_isomorphism}
\leantarget
\leanok
